...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(
        description="Overfitting exploration with permuted targets over multiple "
        "weight initializations on continuous-only CTR23 regression datasets."
    )
    ...
    for _, row in selected.iterrows():
        ...
        try:
            ...
            # The permutation is fixed per dataset so every initialization memorizes the
            # same randomized targets. Only the weight init seed varies.
