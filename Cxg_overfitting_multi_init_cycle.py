...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(
        description="XGBoost overfitting exploration with randomized labels over "
        "multiple subsampling seeds on continuous-only CC18 datasets."
    )
    ...
    for _, row in selected.iterrows():
        ...
        try:
            ...
            # Held-out test split keeps its TRUE labels: a random-label model's test
            ...
            # randomized labels. Only the per-run subsampling seed varies.
